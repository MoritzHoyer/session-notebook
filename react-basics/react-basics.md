...
Um ein Element aus einer Komponente zu erstellen, können wir einfach auf den Funktionsnamen in JSX verweisen und es wie jede eingebaute Komponente behandeln:
...
📙 Lesen Sie mehr über Markup mit JSX schreiben
...
📙 Lesen Sie über Ihre erste Komponente
in der React-Dokumentation.
...
Ressourcen
Was ist React: Eine visuelle Einführung für Anfänger auf learnreact.design
Markup mit JSX schreiben in der React-Dokumentation
JavaScript in JSX mit geschweiften Klammern in der React-Dokumentation
Ihre erste Komponente in der React-Dokumentation
Unterschied zwischen einem Framework und einer Bibliothek auf freecodecamp
Über npm
npm-Website
package.json-Spezifikation
